...
angular.module('myApp.view5', ['ngRoute', 'ui.bootstrap'])
    ...
    .controller('View5Ctrl', function ($scope, $timeout, $interval, $http, $uibModal,$window, $uibPosition,$sce) {
        $scope.title = '点击标题';
        $scope.text = '展开内容';
        ...
        //弹出层
        $scope.divitems = ['item1', 'item2', 'item3'];
